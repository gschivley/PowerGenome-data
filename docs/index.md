...
| `transform_reeds_load.py` | `reeds_load_transformed.parquet` | ReEDS hourly demand HDF5 (`demand_EER2023_IRAlow.h5` on Zenodo, record 18423998; per-model-year groups with 48 state profiles) | Downloads HDF5, filters weather years 2007–2013 and model years 2020–2050, melts to tidy hourly load with time_index. |
